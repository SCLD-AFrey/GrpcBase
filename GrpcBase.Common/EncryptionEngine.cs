...
namespace GrpcBase.Common.Encryption
{
    /// <summary>
    ...
    public static class EncryptionEngine
    {
        ...
        public static byte[] GenerateSalt(int p_saltLength)
        {
        ...
        public static byte[] GenerateCryptoHash(string p_inputString, byte[] p_saltBytes, int p_iterations, int p_hashLength)
        {
        ...
        public static string GetHexStringFromByteArray(byte[] p_byteArray)
        {
        ...
        public static byte[] GetByteArrayFromHexString(string p_hexString)
        {
        ...
        public static KeyPair GenerateNewAsymmetricRsaKeyPair(KeyLength p_keyLength)
        {
        ...
        public static X509Certificate2 GenerateX509Certificate2FromRsaKeyPair(KeyPair p_keyPair, string p_keyFriendlyName)
        {
        ...
        public static void SaveX509Certificate2ToFile(X509Certificate2 p_certificate, string p_filePath,
        ...
        public static X509Certificate2 LoadX509Certificate2FromFile(string p_keyFilePath, SecureString p_keyFilePassword)
        {
        ...
        public static void StoreX509Certificate2InX509Store(X509Certificate2 p_certificate)
        {
        ...
        /// </summary>
        private static void CreateStoreLocation()
        {
        ...
        private static X509Certificate2 LoadX509Certificate2FromThumbprint(string p_thumbprint)
        {
        ...
        private static void RemoveX509Certificate2FromStore(string p_thumbprint)
        {
            if (!CertificateExistsInStore(p_thumbprint))
                throw new KeyNotFoundException(
        ...
        private static bool CertificateExistsInStore(string p_thumbprint)
        {
            var store = new X509Store(StoreName.My, StoreLocation.CurrentUser);
            try
            {
        ...
        public static string EncodeBytesToBase64String(byte[] p_bytes)
        {
            return Convert.ToBase64String(p_bytes);
        }

        public static byte[] DecodeBase64StringToBytes(string p_encodedData)
        {
            return Convert.FromBase64String(p_encodedData);
        }

        public static string GenerateNewHashId()
        {
            var newSalt = GenerateSalt(12);
            return GetHexStringFromByteArray(newSalt);
        }

        public static string GetSha256Checksum(string p_inputFile)
        {
